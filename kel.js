...
//ANAK BGSD SEDANG MAU EDIT KONT** MIKEL TZY NIH BOS
var kuis = false
hit_today = []
ky_ttt = []
...
join = '\`\`\`𝘽𝙚𝙗𝙖𝙣 𝘽𝙖𝙧𝙪\`\`\` \n \`\`\`Nama :\`\`\` \n \`\`\`Askot : \`\`\` \n \`\`\`Umur :\`\`\` \n \`\`\`Status :\`\`\` \n\n - [ MIKEL BOT ] -'
leave = '\`\`\`BYE BEBAN GRUB, NITIP SALAM YA :]\`\`\`'
...
module.exports = ikyy = async (ikyy, kyy) => {
    ...
    const prefix = /^[°Z•π÷×¶∆£¢€¥®™=|~#%^&./\\©^z+,;]/.test(cmd) ? cmd.match(/^[°•Zπ÷×¶∆£¢€¥®™=|~#%^&./\\©^z+,;]/gi) : '!'
       ...
       budy = (type === 'conversation') ? kyy.message.conversation : (type === 'extendedTextMessage') ? kyy.message.extendedTextMessage.text : ''
        ...
        const q = args.join(' ')
const Bfake = fs.readFileSync ('./media/image/mikel.png','base64')
     ...
     let weton = ['Pahing', 'Pon','Wage','Kliwon','Legi'][Math.floor(((d * 1) + gmt) / 84600000) % 5]
        ...
        const freply = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${pushname}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${pushname},;;;\nFN:${pushname},\nitem1.TEL;waid=${senderr.split('@')[0]}:${senderr.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail":fs.readFileSync('./media/Nakano.png')
        }}}
       const math = (teks) => {
      ...
      const hideTag = async function(from, text){
	       ...
	       ikyy.sendMessage(from, {text:text, jpegThumbnail:fs.readFileSync('media/Nakano.png')}, 'extendedTextMessage', {contextInfo: {"mentionedJid": ane}})
}  
...
case 'dijual':
              ...
              if (args.length < 1) return reply('Teksnya?')
              reply('gc ini akan dijual')
              ikyy.groupUpdateSubject(from, `DIJUAL ${body.slice(8)}K`)
              await sleep(1000)
             ikyy.sendMessage(from, 'dah jual aja :v', text, {quoted: mek})
             break
case 'setgcmikel':
if (!isGroup) return reply(mes.only.group)
reply('BISMILLAH MIKEL')
 tessgc = await getBuffer(`https://i.ibb.co/w0n21TX/20210923-222946.png`)
 ikyy.updateProfilePicture (from, tessgc)
 ikyy.updateProfilePicture (from, tessgc)
                   await sleep(1000)
   ikyy.groupUpdateSubject(from, `🔰JB || MIKELSTORE🔰🐟`)
   await sleep(1000)
   ikyy.groupUpdateDescription(from, `AKAN DI GANTI OLEH MIKEL`)
   await sleep(1000)
ikyy.sendMessage(from, 'yessir jadi gc mikel', text, {quoted: mek})
break
case 'sendbug':
...
if (args.length < 2) return reply(`Penggunaan ${command} idgroup`)
        ...
        case 'kontak':
              ...
              if (isNaN(args[1]) && args[1].startsWith('0')) return reply(`Harus berupa angka dan pastikan memasukkan kode negara, contoh: ${command} 628127668234`)
        sendKontak(from, `${q}`, `${q}`, 'SBOK')
               await sleep(1000)
               break
        case 'owner':
        case 'creator':
               sendKontak(from, `62895622483428`, `RAVA STORE`, 'Sibukk!!')
               await sleep(1000)
               sendKontak(from, `${owner}`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               txtt =`Hai Kak ${pushname}\nItu Ownerku, Mau tau soal apa ya?`

               buttons = [{buttonId: '!sourcecode',buttonText:{displayText:'😀SC BOT'},type:1},{buttonId:'!infoig',buttonText:{displayText:'INSTAGRAM'},type:1},{buttonId:'!shop',buttonText:{displayText:'SHOP🛍️'},type:1}]
...
*-JUAL LOGO JB /LOGO 1,5K*
*-JUAL LOGO POSTER FT 3K*
*-JUAL LOGO VECTOR MUKA 5K*
*-JUAL LOGO VECTOR SET FF 6K*
*-JUAL LOGO POSTER DM 2K*
*-JUAL LOGO E-CERTI 1.000p*
*-JUAL PLP LOGO TESTIMONI 1k*
*-JUAL LOGO QR NO PASARAN 1,5K*
*-JUAL LOGO DUO BUCIN/PARTNER 1,5K*
*-JUAL POSTER OPEN MEMBER 3K*
...
ikyy.sendMessage(from, loli, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                    ikyy.sendMessage(from, { contentText: `${menu}`, footerText: 'MIKEL BOT', buttons: [{ buttonId: `!command`, buttonText: { displayText: '📙MENU SIMPLE' }, type: 1 },{ buttonId: `!fitur`, buttonText: { displayText: '🤤 Fitur' }, type: 1 },{ buttonId: `!sewabot`, buttonText: { displayText: '🏷️ SEWA BOT' }, type: 1 },{ buttonId: `!owner`, buttonText: { displayText: 'OWNER 👑' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: ikyads, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
              break
case 'f':
case 'lock':
 ikymemek = {
...
🐟 ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created MIKEL BOT`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @MIKEL BOT`},type:1}]
              ...
              contentText:`Jangan Lupa Follow @MIKEL BOT`,buttons,headerType:4}
...
reply (mess.wait)
                    ...
                    ini_txt = args.join(" ")
             buff = await getBuffer(`https://api.zeks.me/api/${command}?apikey=MIKELtzy66&text=${ini_txt}`)
               buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @MIKEL BOT`,buttons,headerType:4}
...
case 'este':
reply (mess.wait)
             buff = await getBuffer(`https://api.zeks.me/api/estetikpic?apikey=MIKELtzy66`)
               buttons = [{buttonId: `!menu`,buttonText:{displayText: `BACK MENU`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @MIKEL BOT`,buttons,headerType:4}
...
`
    ...
    {buttonId: `${prefix}rules`, buttonText: {displayText: 'S&K'}, type: 1},
               ...
               imageMsg = (await ikyy.prepareMessageMedia(fs.readFileSync(`./media/Menu.png`), 'imageMessage', { thumbnail:Bfake, contextInfo:{forwardingScore: 989, isForwarded: true }})).imageMessage
...
🐟  ${prefix}ytsearch *query*
 ...
 𝔍𝔞𝔫𝔤𝔞𝔫 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔰𝔢𝔰𝔢𝔬𝔯𝔞𝔫𝔤 
  ??𝔞𝔫𝔤 𝔪𝔞𝔰𝔦𝔥 ??𝔢𝔫𝔠𝔦??𝔱𝔞𝔦 𝔪𝔞𝔰𝔞𝔩𝔞𝔩𝔲𝔫𝔶𝔞
...
𝔍𝔞𝔫𝔤𝔞?? 𝔭𝔢𝔯𝔫𝔞𝔥 𝔪𝔢𝔫𝔠𝔦𝔫𝔱𝔞𝔦 𝔰𝔢??𝔢𝔬𝔯𝔞𝔫𝔤 
 ...
 MIKEL BOT☕︎`, imageMessage: imageMsg,
   ...
   //addfiturbokep
				...
				qute = fs.readFileSync('media/Menu.png') 
...
break
			...
			case 'liststicker':
				...
				teks += `\n*Total : ${setiker.length}*`
				ikyy.sendMessage(from, teks.trim(), extendedText, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_「 の ＭｅＩｋｙ あ」_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.png')} } }, contextInfo: { "mentionedJid": setiker } })
				ikyy.sendMessage(from, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_「 の ＭｅＩｋｙ あ」_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.png')}}}})
...
break
			...
			case 'getvn':
			   if (args.length < 1) return reply('Masukan nama yang terdaftar di list vn')
				...
				ikyy.sendMessage(from, buffer, audio, { mimetype: 'audio/mp4',  quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_SelfBot OnlyDev City_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JStw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.png')} }}, ptt: true })
				break
			case 'getsticker':
			case 'gets':
           ...
           case 'liststicker':
			...
			case 'vnlist':
				...
				ikyy.sendMessage(from, teks.trim(), extendedText, {  quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_SelfBot OnlyDev City_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JStw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.png')} }}, contextInfo: { "mentionedJid": audionye } })
				break
			case 'addimage':
            ...
            case 'getimg':
			   if (args.length < 1) return reply('Masukan nama yang terdaftar di list image jika tidak tau .listimage')
				...
				ikyy.sendMessage(from, buffer, image, {  quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_SelfBot OnlyDev City_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JStw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.png')} }}, caption: `Result From Database : ${namastc}.jpeg` })
				break
			case 'imagelist':
			case 'listimage':
				teks = '*List Image :*\n\n'
				...
				ikyy.sendMessage(from, teks.trim(), extendedText, {  quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_SelfBot OnlyDev City_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JStw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.png')} }}, contextInfo: { "mentionedJid": imagenye } })
				break
			...
			case 'videolist':
				...
				ikyy.sendMessage(from, teks.trim(), extendedText, {  quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_SelfBot OnlyDev City_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JStw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('image/odc.png')} }}, contextInfo: { "mentionedJid": videonye } })
				break
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `crated Mikel`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
...
*「 MIKEL BOT 」*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Terimakasih Telah Mendaftar Di Mikel Bot🐟*\n*Masuk Gc Bot Yuk ↓*\n*https://bit.ly/gcbian66*\n*Terimakasih*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Sewa >-------------------
       ...
       case 'listsewa':
              ...
              txtnyee += `*ID :* ${i.id} \n*Expire :* ${cekvipp.days} day(s) \n${cekvipp.hours} hour(s) \n${cekvipp.minutes} minute(s) \n${cekvipp.seconds} second(s)\n\n`
}
              reply(txtnyee)
              break
...
case 'tidak':
  reply('Dahlah ${pushname} Tidak Mau')
  break
case 'sewabot':
             gopeynya = 'https://api.zeks.me/api/bneon?apikey=MIKELtzy66&text=SEWA+BOT+MIKEL'
            buff = await getBuffer(gopeynya)
teksnya = `
BENERAN TIDAK?
`
                        list.push(yy)
  buttons = [{buttonId: `${prefix}sewabot2`,buttonText:{displayText: `YA😎`},type:1},{buttonId: `${prefix}tidak`,buttonText:{displayText: `Tidak😔`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
      ...
      break
       case 'sewabot2':
              gopeynya = 'https://i.ibb.co/r6Nd73N/20210921-211712.png'
            buff = await getBuffer(gopeynya)
            teksnya = `
┏━━⬣ PRICE LIST 1
┃⬡ SEWA 2K/MINGGU
...
┗━━⬣
`
  buttons = [{buttonId: `${prefix}buypremium`,buttonText:{displayText: `Premium`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
      ...
      break
case 'tod':
              gopeynya = 'https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg'
            buff = await getBuffer(gopeynya)
            teksnya = `
...
1. KARENA BISA FITUR JOIN!🤤
2. KARENA AKSES SEPERTI OWNER
...
case 'pay':
               list = []
               listmenu = [`gojek`,`qris`,`dana`,`ovo`]
               listmenuu = [`PAY TO GOPAY`,`PAY TO QRIS`,`PAY TO DANA`,`PAY TO OVO`]
               nombor = 1
               startnum = 0
               for (let x of listmenu) {
               ...
               break 
case 'dana':
             buff = await getBuffer(`https://i.ibb.co/nMCHvYL/20211101-193601.png`)
               buttons = [{buttonId: `!owner`,buttonText:{displayText: `👑Owner`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
              contentText:`${ucapanWaktu} Kak ${pushname}\n\n•> Nama : ${pushname}\n•> Tanggal : ${date}\n•> Hari : ${week}\n•> Waktu :  *${moment().utcOffset('+0700').format('HH:mm')}* WIB\n\n\n*PAYMENT ${command}* \nQR CODE : SCAN FOTO DI ATAS\nAN : MIKEL\nBAYAR SESUAI HARGA YA KAK`,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
...
case 'ovo':
             buff = await getBuffer(`https://i.ibb.co/WtDTjjS/20211101-193506.png`)
               buttons = [{buttonId: `!owner`,buttonText:{displayText: `👑Owner`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
              contentText:`${ucapanWaktu} Kak ${pushname}\n\n•> Nama : ${pushname}\n•> Tanggal : ${date}\n•> Hari : ${week}\n•> Waktu :  *${moment().utcOffset('+0700').format('HH:mm')}* WIB\n\n\n*PAYMENT ${command}* \nQR CODE : SCAN FOTO DI ATAS\nAN : MIKEL\nBAYAR SESUAI HARGA YA KAK`,buttons,headerType:4}
...
case 'gojek':
             buff = await getBuffer(`https://i.ibb.co/V9ddxH1/20211011-151052.png`)
               buttons = [{buttonId: `!owner`,buttonText:{displayText: `👑Owner`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
              contentText:`${ucapanWaktu} Kak ${pushname}\n\n•> Nama : ${pushname}\n•> Tanggal : ${date}\n•> Hari : ${week}\n•> Waktu :  *${moment().utcOffset('+0700').format('HH:mm')}* WIB\n\n\n*PAYMENT ${command}* \nQR CODE : SCAN FOTO DI ATAS\nAN : MIKEL\nBAYAR SESUAI HARGA YA KAK`,buttons,headerType:4}
...
case 'qris':
             buff = await getBuffer(`https://i.ibb.co/Z8qN3gr/16339400308475422167217410216366.png`)
               buttons = [{buttonId: `!owner`,buttonText:{displayText: `👑Owner`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
              contentText:`${ucapanWaktu} Kak ${pushname}\n\n•> Nama : ${pushname}\n•> Tanggal : ${date}\n•> Hari : ${week}\n•> Waktu :  *${moment().utcOffset('+0700').format('HH:mm')}* WIB\n\n\n*PAYMENT ${command} + 1k🐦* \nQR CODE : SCAN FOTO DI ATAS\nAN : MIKEL\nBAYAR SESUAI HARGA YA KAK`,buttons,headerType:4}
...
🐋 Character : ${get_info.characters.join(", ")}\n`
      ...
      case 'kusonime':
       ...
       case 'avatar':
              reply(mess.wait)
              buff = await getBuffer(`https://hardianto.xyz/api/anime/random?sfw=${command}&apikey=hardianto`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'MIKEL BOT', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
 ...
 *🐬 ID Video :* https://youtu.be/${res.all[0].videoId}
...
//------------------< Sticker/Tools >-------------------
      ...
      case 'doge':
       ...
       case 'emoji':
              ...
              ini_buffer = await getBuffer(`https://api.zeks.me/api/emoji-image?apikey=MIKELtzy66&emoji=${emoji}`)
...
break
       ...
       case 'attp2':
              if (args.length == 0) return reply(`Example: ${prefix + command} ikyy`)
              buffer = await getBuffer(`http://hadi-api.herokuapp.com/api/photoxy/wooden-3d-black?teks=${encodeURI(q)}`)
              ikyy.sendMessage(from, buffer, sticker, { quoted: freply })
              break
//MIKEL TZY NIH BOS
              case 'tg': 
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
       ...
       case 'donasi':
            ...
            buff = await getBuffer(gopeynya)
            teksnya = `
DONASI NYA\nRasulullah SAW bersabda bahwa: “Jauhilah neraka walupun hanya dengan (sedekah) sebiji kurma, kalau kamu tidak menemukan sesuatu, maka dengan omongan yang baik.” (HR. Ahmad, Bukhari dan Muslim.* 
`
...
`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `Owner👑`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `PAYMENT`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'NOTE📑:HANYA DI MIKEL', imageMessage: imageMsg,
              contentText: teksnya,buttons,headerType:4}
              prep = await ikyy.prepareMessageFromContent(from,{buttonsMessage},{quoted: freply})
              ikyy.relayWAMessage(prep)
              break
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             ikyy.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 MIKEL BOT NEWS 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
             sendMess(_.jid, `*「 MIKEL BOT BROADCAST」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
ikyy.sendMessage(_.jid, 
			{"contentText": `*「 MIKEL BOT NEWS 」*\n\n${body.slice(4)}`,
			"footerText": 'MIKEL BOT',
			"buttons": [
			{"buttonId": `#command`,
...
//------------------< Fun >-------------------
      ...
      break
       ...
       case 'cekganteng':
              ...
              const gan =['0','5','10','30','20','40','50','60','70','62','74','83','97','100','29','94','75','82','41','39']
       ...
       case 'cekcantik':
              cantik = body.slice(1)
              const can =['0','5','10','30','20','40','50','60','70','62','74','83','97','100','29','94','75','82','41','39']
              const tik = can[Math.floor(Math.random() * can.length)]
              ikyy.sendMessage(from, '*Pertanyaan :* '+cantik+'\n*Jawaban :* '+ tik+'%', text, { quoted: freply })
              break 
       case 'cekjelek':
              jelek  = body.slice(1)
              const jel =['0','5','0','5','10','30','20','40','50','60','70','62','74','83','97','100','29','94','75','82','41','39']
              const ek = jel[Math.floor(Math.random() * jel.length)]
              ikyy.sendMessage(from, '*Pertanyaan :* '+jelek+'\n*Jawaban :* '+ ek+'%', text, { quoted: freply })
              break
       case 'cektolol':
              tolol  = body.slice(1)
              const tol =['0','5','0','5','10','30','20','40','50','60','70','62','74','83','97','100','29','94','75','82','41','39']
              const ol = tol[Math.floor(Math.random() * tol.length)]
              ikyy.sendMessage(from, '*Pertanyaan :* '+tolol+'\n*Jawaban :* '+ ol+'%', text, { quoted: freply })
              break
       case 'cekwatak':
              var namao = pushname
...
//------------------< Lainnya >-------------------
        ...
        case 'tes':
               ...
               break
case 'mikel':
reply('*Halo Bang Saya Mikel Bot🐟*')
break
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              ikyy.sendMessage('62857721057781@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              ikyy.sendMessage('62857721057781@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatrava':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT RAVA DONE')
              ikyy.sendMessage('62895622483428@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/pebian_store/\nDAN\nhttps://www.instagram.com/Rava.Reall/`)
             break
      case 'kelgroup':
      case 'gcmikel':
      case 'mikelgc':
             reply('https://chat.whatsapp.com/FVIlHQHgIgpC5s5105V3eK\nJangan Lupa Join Ya Kak ${pushname}')
             break
      case 'hamdeh':
             reply('Hamdeh hamdeh')
             break
...
if (budy.includes(`Ber`)) {
	reply(`Wajib BerBer Admin Sini/Mikel`)
	}
if (budy.includes(`Berber`)) {
	reply(`Wajib BerBer Admin Sini/Mikel`)
	}
if (budy.includes(`berber`)) {
	reply(`Wajib BerBer Admin Sini/Mikel`)
...
if (budy.includes(`Nama Kamu Siapa`)) {
	reply(`Nama Ku Mikel Tolong Sv Owner Dengan Cara .owner`)
	}
if (budy.includes(`Nama kamu siapa`)) {
	reply(`Nama Ku Mikel Tolong Sv Owner Dengan Cara .owner`)
	}
...
if (budy.includes(`sv`)) {
	reply(`Sv owner saja jangan saya. Dengan Cara .owner`)
	}
if (budy.includes(`Sv`)) {
	reply(`sv owner saja jangan saya. Dengan Cara .owner`)
	}
if (budy.includes(`anjing`)) {
                  ...
                  if (budy.includes(`kel`)) {
                  reply(`Iya kenapa manggil ownerku?`)
                  }
if (budy.includes(`rav`)) {
	reply(`iya kenapa memanggil patnert ku?`)
	}
	if (budy.includes(`Rav`)) {
		reply(`iya kenapa memanggil patnert ku?`)
		}
if (budy.includes(`Kel`)) {
		...
		if (budy.includes(`Assalamualaikum`)) {
                  ...
                  const loli = fs.readFileSync('./assets/mikel.mp3')
